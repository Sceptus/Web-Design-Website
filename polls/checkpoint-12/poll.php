...
<body>
    <h1>MTHS CS Polls</h1>
    <hr />
    <a href="//mthscs.net/vsenthil/polls/checkpoint-12">Home</a>
    &nbsp;&nbsp;|&nbsp;&nbsp;
    <a href="//mthscs.net/vsenthil/polls/checkpoint-12/create.php">Create Poll</a>
    <br />
    <hr />
    <br />
    ...
    <form action="process_poll.php" method="post">
        <?php
            if($voted) {
                echo $pollResponse1 ."&nbsp;&nbsp;&nbsp;". $votesR1 ." votes <br/>
                <table border=\"0\" cellspacing=\"5\" cellpadding=\"0\">
                <tr>
                <td bgcolor=\"blue\" width=\"".(($votesR1/$totalVotes) * 100 * 4)."\"></td>
                <td> (".number_format( ($votesR1/$totalVotes) * 100, 2 )."%)</td>
                </tr>
                </table>
                <br/><br/>";
                echo $pollResponse2 ."&nbsp;&nbsp;&nbsp;". $votesR2 ." votes <br/>
                <table border=\"0\" cellspacing=\"5\" cellpadding=\"0\">
                <tr>
                <td bgcolor=\"blue\" width=\"".(($votesR2/$totalVotes) * 100 * 4)."\"></td>
                <td> (".number_format( ($votesR2/$totalVotes) * 100, 2 )."%)</td>
                </tr>
                </table>
                <br/><br/>"; 

                if($pollResponse3 != "") {
                    echo $pollResponse3 ."&nbsp;&nbsp;&nbsp;". $votesR3 ." votes <br/>
                    <table border=\"0\" cellspacing=\"5\" cellpadding=\"0\">
                    <tr>
                    <td bgcolor=\"blue\" width=\"".(($votesR3/$totalVotes) * 100 * 4)."\"></td>
                    <td> (".number_format( ($votesR3/$totalVotes) * 100, 2 )."%)</td>
                    </tr>
                    </table>
                    <br/><br/>";
                }
                if($pollResponse4 != "") {
                    echo $pollResponse4 ."&nbsp;&nbsp;&nbsp;". $votesR4 ." votes <br/>
                    <table border=\"0\" cellspacing=\"5\" cellpadding=\"0\">
                    <tr>
                    <td bgcolor=\"blue\" width=\"".(($votesR4/$totalVotes) * 100 * 4)."\"></td>
                    <td> (".number_format( ($votesR4/$totalVotes) * 100, 2 )."%)</td>
                    </tr>
                    </table>
                    <br/><br/>";
                }
