...
<head>
    ...
    <title>Polls - Checkpoint #2 - Create Poll</title>
</head>
<body>
    <h1>MTHS CS Polls</h1>
    <hr />
    <a href="//mthscs.net/vsenthil/polls/checkpoint-2">Home</a>
    &nbsp;&nbsp;|&nbsp;&nbsp;
    <a href="//mthscs.net/vsenthil/polls/checkpoint-2/create.php">Create Poll</a>
    <br />
    <hr />
    <br />
