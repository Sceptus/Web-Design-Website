...
<body>
    <?php
        ...
        if(empty($pollQuestion) || empty($pollResponse1) || empty($pollResponse2)) {
            ...
            echo "<meta http-equiv=\"refresh\" content=\"3; URL='//mthscs.net/vsenthil/polls/checkpoint-11/create.php'\">";
            exit();
        }
    ...
    <meta http-equiv="refresh" content="2; URL='//mthscs.net/vsenthil/polls/checkpoint-11'">
</body>
</html>